...
async function seed() {
  ...
  const projects = await Promise.all([
    db.project.create({ data: { contractorId: contractors[0].id, clientId: clients[0].id, title: 'Kiambu County Roads Rehabilitation', projectType: 'roads', contractValue: 12400000, startDate: new Date('2023-09-01'), endDate: new Date('2024-03-31'), actualEnd: new Date('2024-03-28'), status: 'completed', county: 'Kiambu', completionCertificate: 'KCG/CC/2024/0089', description: 'Rehabilitation of 12km of rural roads in Kiambu County including drainage works and culvert installation.' } }),
    db.project.create({ data: { contractorId: contractors[0].id, clientId: clients[1].id, title: 'Parklands Apartment Block (4 floors)', projectType: 'building', contractValue: 18200000, startDate: new Date('2023-02-01'), endDate: new Date('2023-09-30'), actualEnd: new Date('2023-11-10'), status: 'completed', county: 'Nairobi', completionCertificate: 'UHL/PC/2023/0142', description: 'Construction of a 4-storey residential apartment block with 24 units in Parklands, Nairobi.' } }),
    ...
    db.project.create({ data: { contractorId: contractors[1].id, clientId: clients[2].id, title: 'Westlands Storm Drain Rehabilitation', projectType: 'drainage', contractValue: 14200000, startDate: new Date('2024-01-15'), endDate: new Date('2024-07-15'), actualEnd: new Date('2024-07-10'), status: 'completed', county: 'Nairobi', completionCertificate: 'NCG/CC/2024/0201', description: 'Full rehabilitation of the Westlands storm drain system covering 8.5km of primary and secondary drains.' } }),
    ...
    db.project.create({ data: { contractorId: contractors[3].id, clientId: clients[2].id, title: 'Nairobi County Health Clinic Network', projectType: 'building', contractValue: 45000000, startDate: new Date('2023-01-15'), endDate: new Date('2024-01-15'), actualEnd: new Date('2024-01-10'), status: 'completed', county: 'Nairobi', completionCertificate: 'NCG/CC/2024/0156', description: 'Construction of 5 modular health clinics across Nairobi sub-counties.' } }),
  ...
  await Promise.all([
    ...
    db.contractorDocument.create({ data: { contractorId: contractors[0].id, docType: 'completion_certificate', docName: 'CC - Kiambu County Roads Rehabilitation (KCG/CC/2024/0089)', status: 'verified', uploadDate: new Date('2024-04-05') } }),
    db.contractorDocument.create({ data: { contractorId: contractors[0].id, docType: 'completion_certificate', docName: 'CC - Parklands Apartment Block (UHL/PC/2023/0142)', status: 'verified', uploadDate: new Date('2023-12-01') } }),
    ...
    db.contractorDocument.create({ data: { contractorId: contractors[1].id, docType: 'completion_certificate', docName: 'CC - Westlands Storm Drain Rehabilitation (NCG/CC/2024/0201)', status: 'verified', uploadDate: new Date('2024-07-20') } }),
    ...
    db.contractorDocument.create({ data: { contractorId: contractors[3].id, docType: 'completion_certificate', docName: 'CC - Nairobi County Health Clinic Network (NCG/CC/2024/0156)', status: 'verified', uploadDate: new Date('2024-01-20') } }),
